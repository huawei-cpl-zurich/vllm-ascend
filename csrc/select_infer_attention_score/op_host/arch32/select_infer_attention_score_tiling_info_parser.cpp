...
/*!
 * \file select_infer_attention_score_tiling_info_parser.cpp
 * \brief
 */
...
#include "select_infer_attention_score_tiling_info_parser.h"
...
ge::graphStatus FiaInfoParser::GetOpName()
{
    if (context_->GetNodeName() == nullptr) {
        OP_LOGE("SelectInferAttentionScore", "opName got from TilingContext is nullptr");
        return ge::GRAPH_FAILED;
    }
...
{
    if (context_ == nullptr) {
        OP_LOGE("SelectInferAttentionScore", "tiling context is nullptr!");
        return ge::GRAPH_FAILED;
    }
