...
/*!
 * \file select_infer_attention_score_tiling.h
 * \brief
 */
...
//MLA非量化模板TilingData
BEGIN_TILING_DATA_DEF(SelectInferAttentionScoreTilingData)
...
BEGIN_TILING_DATA_DEF(SelectInferAttentionScoreEmptyTensorTilingData)
...
// Keep legacy aliases used by shared arch32/common tiling helpers.
using FusedInferAttentionScoreTilingData = SelectInferAttentionScoreTilingData;
using FusedInferAttentionScoreEmptyTensorTilingData = SelectInferAttentionScoreEmptyTensorTilingData;
...
extern "C" {
ge::graphStatus DeviceDoOpTilingSelectInferAttentionScore(gert::TilingContext *context);
}
