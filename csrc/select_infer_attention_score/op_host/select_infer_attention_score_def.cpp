...
/*!
 * \file select_infer_attention_score_def.cpp
 * \brief
 */
...
namespace ops {
class SelectInferAttentionScore : public OpDef {
public:
    SelectInferAttentionScore(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
        ...
        aicore_config.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "select_infer_attention_score")
...
OP_ADD(SelectInferAttentionScore, optiling::SelectInferAttentionScoreCompileInfo);
} // namespace ops
