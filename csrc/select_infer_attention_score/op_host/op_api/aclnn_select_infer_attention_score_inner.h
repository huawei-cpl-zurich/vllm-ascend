...
#ifndef ACLNN_SELECT_INFER_ATTENTION_SCORE_INNER_H_
#define ACLNN_SELECT_INFER_ATTENTION_SCORE_INNER_H_
...
void SelectInferAttentionScoreProcessSoftmaxLse(bool softmaxLseFlag, const aclTensor *softmaxLse,
