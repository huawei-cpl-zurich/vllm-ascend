...
#include "aclnn_select_infer_attention_score_v4.h"

#include "opdev/common_types.h"
#include "opdev/make_op_executor.h"
#include "opdev/op_def.h"
#include "opdev/op_log.h"
#include "aclnn_select_infer_attention_score_inner.h"
 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnSelectInferAttentionScoreV4GetMaxWorkspaceSize(
...
aclnnStatus aclnnSelectInferAttentionScoreV4GetMaxWorkspaceSize(
    ...
    const aclTensor *attentionOut, const aclTensor *softmaxLse, uint64_t *workspaceSize, aclOpExecutor **executor)
{
    OP_LOGD("start aclnnSelectInferAttentionScoreV4GetMaxWorkspaceSize");
    ...
    SelectInferAttentionScoreProcessSoftmaxLse(softmaxLseFlag, softmaxLse, tempTensor, placeHolder);
...
aclnnStatus aclnnSelectInferAttentionScoreV4GetWorkspaceSize(
...
aclnnStatus aclnnSelectInferAttentionScoreV4(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
