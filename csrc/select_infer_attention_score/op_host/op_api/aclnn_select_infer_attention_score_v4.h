...
#ifndef ACLNN_SELECT_INFER_ATTENTION_SCORE_V4_H_
#define ACLNN_SELECT_INFER_ATTENTION_SCORE_V4_H_
...
/**
 * @brief The first interface of aclnnSelectInferAttentionScoreV4 calculates the workspace size based on the specific calculation process.
 * @domain aclnn_ops_infer
 */
__attribute__((visibility("default"))) aclnnStatus aclnnSelectInferAttentionScoreV4GetWorkspaceSize(
...
/**
 * @brief The second interface of aclnnSelectInferAttentionScoreV4 is used to perform calculations.
 */
__attribute__((visibility("default"))) aclnnStatus aclnnSelectInferAttentionScoreV4(void *workspace,
