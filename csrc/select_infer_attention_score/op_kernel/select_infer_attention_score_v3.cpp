...
/*!
 * \file select_infer_attention_score_v3.cpp
 * \brief
 */
...
// 在这组DType中，若没有mla模板的key，包含mla模板编译会报错：unknown type name 'SelectInferAttentionScoreTilingData'
...
#define INVOKE_FIA_OP_GENERAL_IMPL(templateClass, CubeBlockType, VecBlockType, FdBlockType, ...)                       \
    do {                                                                                                               \
        ...
        FIA_COPY_TILING_DATA(SelectInferAttentionScoreTilingData, tiling);                                              \
...
// empty tensor 模板
    ...
    FIA_COPY_TILING_DATA(SelectInferAttentionScoreEmptyTensorTilingData, tiling);
