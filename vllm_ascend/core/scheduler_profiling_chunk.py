...
class ProfilingChunkScheduler(Scheduler):
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        while req_index < len(self.running) and token_budget > 0:
            ...
            # >>> PROFILING CHUNK: capture full remaining prompt before caps
            ...
            # >>> PROFILING CHUNK: dynamic chunk sizing for RUNNING continuation
        ...
        if not preempted_reqs and self._pause_state == PauseState.UNPAUSED:
            ...
            while (self.waiting or self.skipped_waiting) and token_budget > 0 and waiting_budget > 0:
                ...
                if load_kv_async:
                    ...
                    num_new_tokens = min(num_new_tokens, token_budget)
                    # >>> PROFILING CHUNK: dynamic chunk sizing for WAITING new prefill
                    num_new_tokens = self._apply_dynamic_chunk_size(
...
class AsyncProfilingChunkScheduler(AsyncScheduler, ProfilingChunkScheduler):
